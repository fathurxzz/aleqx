...
c){var b=p(c);B(a,c,M(q(),b))}function G(a,e,g,k){k=void 0!=k?k.slice():J(a._valueGet()).split("");c.each(d,function(a,c){"object"==typeof c&&(c.buffer=c._buffer.slice(),c.lastValidPosition=-1)});!0!==g&&(f=0);e&&a._valueSet("");u();c.each(k,function(d,f){var k=b().lastValidPosition,m=-1==k?d:r(k);(g&&s(d)||(f!=M(q().slice(),d,!0)||s(d))&&-1==c.inArray(f,q().slice(k+1,m)))&&c(a).trigger("_keypress",[!0,f.charCodeAt(0),e,g,d])});!0===g&&(b().lastValidPosition=y(b().p))}function L(a){return c.inputmask.escapeRegex.call(this,
...
setTimeout(function(){var c=r(b().lastValidPosition);a.insertMode||c!=u()||h.shiftKey||c--;w(g,h.shiftKey?n.begin:c,c)},0):l==a.keyCode.HOME&&!h.shiftKey||l==a.keyCode.PAGE_UP?w(g,0,h.shiftKey?n.begin:0):l==a.keyCode.ESCAPE?G(g,!0,!0,R):l!=a.keyCode.INSERT||h.shiftKey||h.ctrlKey?!1!=a.insertMode||h.shiftKey||(l==a.keyCode.RIGHT?setTimeout(function(){var a=w(g);w(g,a.begin)},0):l==a.keyCode.LEFT&&setTimeout(function(){var a=w(g);w(g,a.begin-1)},0)):(a.insertMode=!a.insertMode,w(g,a.insertMode||n.begin!=
u()?n.begin:n.begin-1));m=w(g);a.onKeyDown.call(this,h,e(),a);w(g,m.begin,m.end);Y=-1!=c.inArray(l,a.ignorables)}function L(h,m,l,q,n,p){if(void 0==l&&W)return!1;W=!0;var t=c(this);h=h||window.event;l=l||h.which||h.charCode||h.keyCode;if((!h.ctrlKey||!h.altKey)&&(h.ctrlKey||h.metaKey||Y)&&!0!==m)return!0;if(l){!0!==m&&46==l&&!1==h.shiftKey&&","==a.radixPoint&&(l=44);var x,v,z,A=String.fromCharCode(l);m?(l=n?p:b().lastValidPosition+1,x={begin:l,end:l}):x=w(this);l=ba(x.begin,x.end);var D=!1;p=f;l&&
(E&&(v=x.end,x.end=x.begin,x.begin=v),c.each(d,function(c,d){if("object"==typeof d){f=c;b().undoBuffer=e().join("");var h=x.end<u()?x.end:u();b().lastValidPosition>x.begin&&b().lastValidPosition<h?b().lastValidPosition=y(x.begin):D=!0;K(e(),x.begin,h);var g=u();if(!1==a.greedy)H(x.begin,g);else for(var k=x.begin;k<h;k++)s(k)&&H(x.begin,g)}}),!0===D&&(f=p,G(this,!1,!0,e()),a.insertMode||c.each(d,function(a,c){"object"==typeof c&&(f=a,I(x.begin,u(),Q(x.begin),!0),b().lastValidPosition=r(b().lastValidPosition))})),
