    ...
    function b(b, c) {
        function w(a) {
            if (!(g.ratio >= 1)) {
                ...
                n = o.now * h.ratio; g.obj.css(l, -n); j.obj.css(l, o.now)
            } return false
        }
        function v(b) {
        ...
        function u(b) {
            if (!(g.ratio >= 1)) {
                ...
                var d = b.wheelDelta ? b.wheelDelta / 120 : -b.detail / 3; n -= d * c.wheel; n = Math.min(g[c.axis] - f[c.axis], Math.max(0, n));
                j.obj.css(l, n / h.ratio); g.obj.css(l, -n);
                b = a.event.fix(b); b.preventDefault()
            }
        }
        function t(b) {
            ...
            document.ontouchmove = function (b) {
                a(document).unbind("mousemove"); w(b.touches[0])
            };
            ...
            } else if (c.scroll) { e[0].onmousewheel = u }
        } function r() {
            j.obj.css(l, n / h.ratio);
            g.obj.css(l, -n); p["start"] = j.obj.offset()[l];
            var a = m.toLowerCase();
