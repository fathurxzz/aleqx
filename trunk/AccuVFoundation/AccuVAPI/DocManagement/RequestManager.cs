...
namespace AccuVAPI.Controllers
{
    public class RequestManager
    {
        ...
        {
            return SendPOSTRequest(uri, content, null, null, true);
        }
        ...
        public HttpWebResponse SendGETRequest(string uri, string bearerToken)
        {
            HttpWebRequest request = GenerateGETRequest(uri, null, null, true);
        ...
        {
            return SendGETRequest(uri, null, null, true);
        }
        ...
        {
            return GenerateGETRequest(uri, null, null, true);
        }
        ...
        {
            return GeneratePOSTRequest(uri, content, null, null, true);
        }
