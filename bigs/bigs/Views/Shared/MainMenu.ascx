...
<div id="menuContainer">
    ...
    <div id="menuCentre">
        ...
        <%=Html.ActionLink(" ", "Index", "Vacancies", new { contentUrl = Html.ResourceString("Vacancies") }, new { @class = controllerName == "VACANCIES" ? shortLang + "vacancies " + shortLang + "vacanciesActive" : shortLang + "vacancies" })%>
