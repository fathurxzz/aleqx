...
namespace SpaceGame.Api.Clauses
{
    ...
    {
        public static TimeSpan Caclulate(long metal, long crystal, short robotsLevel, short nanitesLevel, short techLevelTo, GameEntity gameEntity)
        {
            ...
            if (gameEntity != GameEntity.NaniteFactory)
